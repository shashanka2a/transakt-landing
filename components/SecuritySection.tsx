  ...
  const sponsors = [
    ...
    },
    {
      ...
      points: [
        ...
        "Step-up cryptographic authorization for high-value transfers & policy changes",
        "Zero biometric data stored or transmitted—verified purely via 1:1 ZK-SNARKs",
      ],
